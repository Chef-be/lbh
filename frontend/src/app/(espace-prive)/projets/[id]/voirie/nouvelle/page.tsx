...
export default function PageNouvelleEtudeVoirie({ params }: { params: { id: string } }) {
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <Link href={`/projets/${params.id}/voirie`} className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700 mb-2">
      ...
      <FormulaireNouvelleEtudeVoirie projetId={params.id} />
    </div>
  );
}
